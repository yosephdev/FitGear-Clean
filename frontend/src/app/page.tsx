    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="bg-gradient-to-r from-blue-600 to-purple-700 text-white py-20">
        <div className="container mx-auto px-4 text-center">
          <h1 className="text-5xl font-bold mb-4">Welcome to FitGear</h1>
          <p className="text-xl mb-8 max-w-2xl mx-auto">
            Discover premium fitness equipment and apparel to elevate your workout experience.
          </p>
      ...
      <section className="container mx-auto px-4 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-gray-600 max-w-2xl mx-auto">
            Explore our carefully curated selection of high-quality fitness gear
          </p>
        </div>
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">Expert customer support team</p>
            </div>
          </div>
        </div>
      </section>
