    ...
    <div className="container-max py-12 px-4 sm:px-6 lg:px-8">
      <div className="bg-white shadow-md rounded-lg p-8">
        ...
        <div className="prose max-w-none">
          ...
          <p>
            Our Service may contain links to third-party web sites or services that are not owned or controlled by FitGear.
            FitGear has no control over, and assumes no responsibility for, the content, privacy policies, or practices of any third-party web sites or services.
          </p>
